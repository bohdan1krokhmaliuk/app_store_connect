...
import 'package:app_store_connect/src/model/app_price_response.dart';
...
class AppPricesApi {
  ...
  const AppPricesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AppPriceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppPriceResponse>> appPricesGetInstance({
    required String id,
    ...
    final _path = r'/v1/appPrices/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    AppPriceResponse _responseData;

    try {
      const _responseType = FullType(AppPriceResponse);
    ...
    return Response<AppPriceResponse>(
      data: _responseData,

...
import 'package:app_store_connect/src/model/beta_app_localization_create_request.dart';
import 'package:app_store_connect/src/model/beta_app_localization_response.dart';
import 'package:app_store_connect/src/model/beta_app_localization_update_request.dart';
...
class BetaAppLocalizationsApi {
  ...
  const BetaAppLocalizationsApi(this._dio, this._serializers);
  ...
  Future<Response<AppResponse>> betaAppLocalizationsAppGetToOneRelated({
    required String id,
    ...
    final _path = r'/v1/betaAppLocalizations/{id}/app'.replaceAll('{' r'id' '}', id.toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BetaAppLocalizationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BetaAppLocalizationResponse>> betaAppLocalizationsCreateInstance({
    required BetaAppLocalizationCreateRequest betaAppLocalizationCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/betaAppLocalizations';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BetaAppLocalizationCreateRequest);
      _bodyData = _serializers.serialize(betaAppLocalizationCreateRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    BetaAppLocalizationResponse _responseData;

    try {
      const _responseType = FullType(BetaAppLocalizationResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BetaAppLocalizationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> betaAppLocalizationsDeleteInstance({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/betaAppLocalizations/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BetaAppLocalizationsResponse>> betaAppLocalizationsGetCollection({
  ...
  /// Returns a [Future] containing a [Response] with a [BetaAppLocalizationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BetaAppLocalizationResponse>> betaAppLocalizationsGetInstance({
    required String id,
    BuiltList<String>? fieldsLeftSquareBracketBetaAppLocalizationsRightSquareBracket,
    BuiltList<String>? include,
    BuiltList<String>? fieldsLeftSquareBracketAppsRightSquareBracket,
  ...
  /// Returns a [Future] containing a [Response] with a [BetaAppLocalizationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BetaAppLocalizationResponse>> betaAppLocalizationsUpdateInstance({
    required String id,
    required BetaAppLocalizationUpdateRequest betaAppLocalizationUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BetaAppLocalizationUpdateRequest);
      _bodyData = _serializers.serialize(betaAppLocalizationUpdateRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,

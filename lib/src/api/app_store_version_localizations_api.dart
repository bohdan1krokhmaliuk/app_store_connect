...
import 'package:app_store_connect/src/model/app_store_version_localization_create_request.dart';
import 'package:app_store_connect/src/model/app_store_version_localization_response.dart';
import 'package:app_store_connect/src/model/app_store_version_localization_update_request.dart';
...
class AppStoreVersionLocalizationsApi {
  ...
  const AppStoreVersionLocalizationsApi(this._dio, this._serializers);
  ...
  Future<Response<AppPreviewSetsResponse>> appStoreVersionLocalizationsAppPreviewSetsGetToManyRelated({
    required String id,
    ...
    final _path = r'/v1/appStoreVersionLocalizations/{id}/appPreviewSets'.replaceAll('{' r'id' '}', id.toString());
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppScreenshotSetsResponse>> appStoreVersionLocalizationsAppScreenshotSetsGetToManyRelated({
    required String id,
    ...
    final _path = r'/v1/appStoreVersionLocalizations/{id}/appScreenshotSets'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AppStoreVersionLocalizationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppStoreVersionLocalizationResponse>> appStoreVersionLocalizationsCreateInstance({
    required AppStoreVersionLocalizationCreateRequest appStoreVersionLocalizationCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/appStoreVersionLocalizations';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AppStoreVersionLocalizationCreateRequest);
      _bodyData = _serializers.serialize(appStoreVersionLocalizationCreateRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    AppStoreVersionLocalizationResponse _responseData;

    try {
      const _responseType = FullType(AppStoreVersionLocalizationResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<AppStoreVersionLocalizationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> appStoreVersionLocalizationsDeleteInstance({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/appStoreVersionLocalizations/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AppStoreVersionLocalizationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppStoreVersionLocalizationResponse>> appStoreVersionLocalizationsGetInstance({
    required String id,
    BuiltList<String>? fieldsLeftSquareBracketAppStoreVersionLocalizationsRightSquareBracket,
    BuiltList<String>? include,
    BuiltList<String>? fieldsLeftSquareBracketAppScreenshotSetsRightSquareBracket,
  ...
  /// Returns a [Future] containing a [Response] with a [AppStoreVersionLocalizationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppStoreVersionLocalizationResponse>> appStoreVersionLocalizationsUpdateInstance({
    required String id,
    required AppStoreVersionLocalizationUpdateRequest appStoreVersionLocalizationUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AppStoreVersionLocalizationUpdateRequest);
      _bodyData = _serializers.serialize(appStoreVersionLocalizationUpdateRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _options.compose(
          _dio.options,

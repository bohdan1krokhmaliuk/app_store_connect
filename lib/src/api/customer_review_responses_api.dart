...
class CustomerReviewResponsesApi {
  ...
  const CustomerReviewResponsesApi(this._dio, this._serializers);
  ...
  Future<Response<CustomerReviewResponseV1Response>> customerReviewResponsesCreateInstance({
    required CustomerReviewResponseV1CreateRequest customerReviewResponseV1CreateRequest,
    ...
    final _path = r'/v1/customerReviewResponses';
    ...
    try {
      const _type = FullType(CustomerReviewResponseV1CreateRequest);
      _bodyData = _serializers.serialize(customerReviewResponseV1CreateRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> customerReviewResponsesDeleteInstance({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/customerReviewResponses/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [CustomerReviewResponseV1Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CustomerReviewResponseV1Response>> customerReviewResponsesGetInstance({
    required String id,

...
part 'ci_workflow_update_request_data_attributes.g.dart';
...
/// * [clean]
/// * [containerFilePath]
abstract class CiWorkflowUpdateRequestDataAttributes
    implements Built<CiWorkflowUpdateRequestDataAttributes, CiWorkflowUpdateRequestDataAttributesBuilder> {
  ...
  CiWorkflowUpdateRequestDataAttributes._();

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CiWorkflowUpdateRequestDataAttributesBuilder b) => b;

  factory CiWorkflowUpdateRequestDataAttributes([void updates(CiWorkflowUpdateRequestDataAttributesBuilder b)]) =
      _$CiWorkflowUpdateRequestDataAttributes;

  @BuiltValueSerializer(custom: true)
  static Serializer<CiWorkflowUpdateRequestDataAttributes> get serializer =>
      _$CiWorkflowUpdateRequestDataAttributesSerializer();
}

class _$CiWorkflowUpdateRequestDataAttributesSerializer
    implements StructuredSerializer<CiWorkflowUpdateRequestDataAttributes> {
  @override
  final Iterable<Type> types = const [CiWorkflowUpdateRequestDataAttributes, _$CiWorkflowUpdateRequestDataAttributes];

  @override
  final String wireName = r'CiWorkflowUpdateRequestDataAttributes';

  @override
  Iterable<Object?> serialize(Serializers serializers, CiWorkflowUpdateRequestDataAttributes object,
  ...
  @override
  CiWorkflowUpdateRequestDataAttributes deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = CiWorkflowUpdateRequestDataAttributesBuilder();

...
part 'app_info_localization_attributes.g.dart';
...
/// * [privacyChoicesUrl]
/// * [privacyPolicyText]
abstract class AppInfoLocalizationAttributes
    implements Built<AppInfoLocalizationAttributes, AppInfoLocalizationAttributesBuilder> {
  ...
  AppInfoLocalizationAttributes._();

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AppInfoLocalizationAttributesBuilder b) => b;

  factory AppInfoLocalizationAttributes([void updates(AppInfoLocalizationAttributesBuilder b)]) =
      _$AppInfoLocalizationAttributes;

  @BuiltValueSerializer(custom: true)
  static Serializer<AppInfoLocalizationAttributes> get serializer => _$AppInfoLocalizationAttributesSerializer();
}

class _$AppInfoLocalizationAttributesSerializer implements StructuredSerializer<AppInfoLocalizationAttributes> {
  @override
  final Iterable<Type> types = const [AppInfoLocalizationAttributes, _$AppInfoLocalizationAttributes];

  @override
  final String wireName = r'AppInfoLocalizationAttributes';

  @override
  Iterable<Object?> serialize(Serializers serializers, AppInfoLocalizationAttributes object,
  ...
  @override
  AppInfoLocalizationAttributes deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = AppInfoLocalizationAttributesBuilder();
